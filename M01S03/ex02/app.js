...
console.log(
  'Prietena mea Carol Carolson are ' + person.friends.carol.age + ' ani.',
);
...
console.warn(`Afiseaza numarul de caractere al numelui de familie al lui Larry
`);
console.log(person.friends.larry.name.length.toString());
